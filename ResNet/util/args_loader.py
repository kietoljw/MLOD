...
def get_args():
    ...
    parser.add_argument('--file', default='trained_model/resnet18_cifar10.pth.tar', type=str, help='pretrained file')
    parser.add_argument('--K', default=50, type=int, help='KNN')
    parser.add_argument('--CIFAR-10-model-zoo', default=['resnet18_cifar','resnet34_cifar', 'resnet50_cifar'], nargs="*", type=str, help="model zoo list")
    parser.add_argument('--multi-method', default=['BH','adaBH','BY','Fisher','Cauchy','all'], type=str, 
                        help="multi method")
